...
class MY_Controller extends CI_Controller {
	...
	public function __construct() 
	{
		...
		$this->info = [
			'applicationName'          => "Alpha Tomo (P) Int'l Manpower Services, Inc.",
			'applicationDescription'   => "Alpha Tomo (P) Int'l Manpower Services, Inc.",
			'author'                   => '',
			'email'                    => '',
		];
...
class Employer_Controller extends MY_Controller {
	...
	public function __construct() 
	{
		...
		$this->info['applicationName']	= "Alpha Tomo (P) Int'l Manpower Services, Inc.";  
