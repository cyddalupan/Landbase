...
<div class="modal-body">
    <div class="bootbox-body">
		...
		<div class="row">			
			...
			<div class="col-sm-5">
				<select name="applicant[recruitmentAgent]" class="form-control">
					<option value="">-- All --</option>
					<?php foreach ( $recruitmentAgents as $recruitmentAgent ): ?>
					<option value="<?php echo $recruitmentAgent['agent_id']; ?>"><?php echo $recruitmentAgent['agent_first'].' '.$recruitmentAgent['agent_last']; ?></option>
					<?php endforeach; ?>
				</select>
			</div>
		</div>
