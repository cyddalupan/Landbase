            ...
            <div class="navbar-container">
                ...
                <div class="navbar-header pull-left">
                    <a href="#" class="navbar-brand">
                        <small>
                            <img src="<?php echo $app->getPath()['images']; ?>logo.png" alt="" />
                        </small>
                    </a>
                </div>
                <!-- /Navbar Barnd -->
                ...
                <div class="navbar-header pull-right">
                    <div class="navbar-account">
                        <ul class="account-area">
                            ...
                            <li class="">
                                <a href="<?php href( 'admin/applicants/all?status=For Review' ); ?>" title="For Review">
                            ...
                            <li>
                                <a class="login-area dropdown-toggle" data-toggle="dropdown">
                                    <div class="avatar" title="View your public profile">
                                        <img src="<?php echo $app->getPath()['images']; ?>avatars/ics-ipac.jpg">
                                    </div>
                                    <section>
                                ...
                                <ul class="pull-right dropdown-menu dropdown-arrow dropdown-login-area">
                                    ...
                                    <li>
                                        <div class="avatar-area">
                                            <img src="<?php echo $app->getPath()['images']; ?>avatars/ics-ipac.jpg" class="avatar">
