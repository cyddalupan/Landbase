                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <select name="search[status]" class="form-control input-sm">
                                            ...
                                            <option value="0" <?php if(isset($get['search']['status'])){ if($get['search']['status'] == 0) echo 'selected';} ?>>Available</option>
                                            <option value="4" <?php if(isset($get['search']['status'])){ if($get['search']['status'] == 4) echo 'selected';} ?>>Selected</option>
                                            <option value="5" <?php if(isset($get['search']['status'])){ if($get['search']['status'] == 5) echo 'selected';} ?>>Line Up</option>
                                            <option value="8" <?php if(isset($get['search']['status'])){ if($get['search']['status'] == 8) echo 'selected';} ?>>For Deployment</option>
                                            <option value="9" <?php if(isset($get['search']['status'])){ if($get['search']['status'] == 9) echo 'selected';} ?>>Deployed</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <label>Recruitment Agenct</label> 
                                        <select name="search[recruitmentAgent]" class="form-control input-sm">
                                            <option value="0">-- Select Recruitment Agenct --</option>
                                            <?php foreach ($recruitmentAgents as $recruitmentAgent): ?>
                                            <option value="<?php echo $recruitmentAgent['agent_id']; ?>" <?php if(isset($get['search']['recruitmentAgent'])){ if($get['search']['recruitmentAgent'] == $recruitmentAgent['agent_id']) echo 'selected';} ?>><?php echo $recruitmentAgent['agent_first'].' '.$recruitmentAgent['agent_last']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <table id="cyd_applicant_list" class="table table-bordered table-hover table-applicants">
                            ...
                            <tbody>
                                ...
                                <tr class="<?php echo in_array( $_SESSION['admin']['user']['user_type'], [7]) ? 'record-except' : ''; ?>">
                                    ...
                                    <td class="numeric">
                                       STMA-<?php echo str_pad( $applicant['applicant_id'], 7, '0', STR_PAD_LEFT ); ?> 
                                    </td>
                                    <td class="numeric">
                                        ...
                                        <?php endif; ?> 
                                        <?php 
                                        if(isset($applicants_raw[$applicant['applicant_id']]->applicantNumber))
