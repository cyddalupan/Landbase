                        ...
                        <table class="table table-bordered table-hover table-applicants">
                            ...
                            <thead class="bordered-palegreen">
                                <tr>
                                    ...
                                    <th>VISA</th>
									<th>Inhouse </br>Training</th>
                                    <th>Tesda</th>
									<th>PDOS</th>
									 <th>OWWA </br>certificate</th>
									<th>OWWA </br>Submission</th>
                                 
									<th>VISA STAMP </br>SUBMISSION</th>
									<th>VISA STAMP </br>RELEASE</th>
								
                                    <th>Insurance #</th>
									<th>OEC </br>Submission</th>
									<th>OEC </br>Release</th>
									<th>Ticket</th>
									<th>Remarks</th>
                            ...
                            <tbody>
                                ...
                                <tr>
									...
									<td align="center">
									 ...
									 <td align="center">
                                        ...
                                        if(isset($applicant_certificate_raw))
                                            $valuetraining=$applicant_certificate_raw[$applicant['applicant_id']]->certificate_training;
                                        ?>
                                        <?php if ($valuetraining == 1 ): ?>
                                        <span class="text-success"><i class="fa fa-check"></i></span>
                                        <?php else: ?>
                                        --
                                        <?php endif; ?>
									...
									<td>
										<?php if ( $applicant['requirement_owwa_schedule'] == '0000-00-00' ): ?>
										--
                                        <?php else: ?>
									...
									<?php
										if(isset($applicant_requirement_raw))
                                            $visastamp=$applicant_requirement_raw[$applicant['applicant_id']]->requirement_visa_stamp;
										?>
										
										<?php if (  $visastamp == '0000-00-00' ): ?>
											---
                                        <?php else: ?>
											<?php echo fdate('d-M-Y', $applicant_requirement_raw[$applicant['applicant_id']]->requirement_visa_stamp,'---');?>
                                        <?php endif; ?>
									...
									<td>
										<?php if (  $applicant['requirement_oec_submission_date'] == '0000-00-00' ): ?>
                                        ---
                                        <?php else: ?>
                                        <?php echo fdate( 'd-M-Y', $applicant['requirement_oec_submission_date'], '0000-00-00' ); ?>
                                        <?php endif; ?>
                                     
                                    </td>
									<td>
										<?php if (  $applicant['requirement_oec_release_date'] == '0000-00-00' ): ?>
											---
                                        <?php else: ?>
                                         <?php echo fdate( 'd-M-Y', $applicant['requirement_oec_release_date'], '0000-00-00' ); ?>
                                        <?php endif; ?>
									...
									<td>
										...
										<?php if (  $flight == '0000-00-00' ): ?>
											---
                                        <?php else: ?>
											<?php echo fdate('d-M-Y', $applicant_requirement_raw[$applicant['applicant_id']]->flight_date,'---');?>
                                        <?php endif; ?>
