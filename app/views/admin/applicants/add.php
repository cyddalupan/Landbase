										...
										<div class="form-title">
                                         ...
                                         <hr class="wide" />
                                                ...
                                                <div class="col-sm-4">
												  ...
												  <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <span class="input-icon icon-right">
                                                            <div class="input-group">
                                                                <input name="applicant[passport][issue]" type="text" data-date-format="yyyy-mm-dd" class="form-control date-picker cyd-issue-date" placeholder="yyyy-mm-dd" value="<?php echo isset( $post['applicant']['passport']['issue'] ) ? $post['applicant']['passport']['issue'] : date( 'Y-m-d', time() ); ?>">
                                                                <span class="input-group-addon">
                                                                    <i class="fa fa-calendar"></i>
                                                                </span>
                                                            </div>
                                                ...
                                                <div class="col-sm-4">
												 ...
												 <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <span class="input-icon icon-right">
                                                            <div class="input-group">
                                                                <input name="applicant[passport][expiration]" type="text" data-date-format="yyyy-mm-dd" class="form-control date-picker cyd-expired-date" placeholder="yyyy-mm-dd" value="<?php echo isset( $post['applicant']['passport']['expiration'] ) ? $post['applicant']['passport']['expiration'] : date( 'Y-m-d', time() ); ?>">
                                                                <span class="input-group-addon">
                                                                    <i class="fa fa-calendar"></i>
                                                                </span>
                                                            </div>
                                            ...
                                            */ ?>
                                            ...
                                            <div class="form-title">
                                                <strong>(5) Personal Abilities </strong>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-10">
                                     				<div class="form-group">
                                                        ...
                                                        <input name="applicant[basic][personalAbilities]" type="text"  data-role="tagsinput" value="<?php echo isset( $post['applicant']['basic']['personalAbilities'] ) ? $post['applicant']['basic']['personalAbilities'] : ''; ?>">
                                                    </div>
