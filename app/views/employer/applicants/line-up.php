...
?>
	<div class="col-md-9 col-sm-8">
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-3 col-xs-4" style="height:500px;border:0px solid black">
				<div class="result-item">
                    ...
                    <div class="well">
                        <p>
                            ...
                            <strong><span class="text-danger">ATP-<?php echo str_pad( $applicant['applicant_id'], 6, '0', STR_PAD_LEFT ); ?></span></strong>
                         </p>
                    </div>
                    <div class="well">
