                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    ?>  class="">
                                        <td><?php echo $ctr; ?></td>
                                        <td>ATP-<?php echo str_pad( $applicant['applicant_id'], 9, '0', STR_PAD_LEFT ); ?></td>
                                        ...
                                        <td><span class="text-danger"><?php echo ! empty( $applicant['passport'] ) ? $applicant['passport']['passport_number'] : 'FOR UPDATE'; ?></span></td>
