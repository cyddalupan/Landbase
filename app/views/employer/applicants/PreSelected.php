           ...
           <div class="row">
              <div class="col-md-12">
                 ...
                 <div class="hero">
                    ...
                    <h3><span> Pre-Selected Applicants</span></h3>
                    <!-- para -->
                 </div> 
                 
                 <div class="row">
                    <div class="col-md-16"  style="overflow:scroll; padding-bottom:20px;">
                            ...
                            <table class="table table-hover table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    ?>  class="">
                                        ...
                                        <td>ATP-<?php echo str_pad( $applicant['applicant_id'], 7, '0', STR_PAD_LEFT ); ?></td>
